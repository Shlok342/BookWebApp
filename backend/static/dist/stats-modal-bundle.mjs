...
var y, b, x, ee = o((() => {
	y = "bibliotheca_token", b = {
		getToken: () => localStorage.getItem(y),
		setToken: (e) => localStorage.setItem(y, e),
		clearToken: () => localStorage.removeItem(y),
		isLoggedIn: () => !!localStorage.getItem(y),
		async login(e, t) {
		...
		logout() {
			b.clearToken(), window.location.reload();
		}
	}, x = window.fetch, window.fetch = async (...e) => {
		let t = await x(...e), n = e[0]?.toString() || "", r = e[1];
		return t.status === 401 && b.getToken() && v(r) && !n.includes("/auth/login") && !n.includes("/auth/register") && b.logout(), t;
	};
})), S, C = o((() => {
	ee(), S = {
		_headers(e = {}) {
		...
		async getBooks() {
			let e = await fetch("/books", { headers: S._headers() });
		...
		async getStats() {
			let e = await fetch("/stats", { headers: S._headers() });
			if (!e.ok) throw Error("Failed to fetch stats");
			return e.json();
		},
		async getGlobalStreak() {
			let e = await fetch("/streak", { headers: S._headers() });
			if (!e.ok) throw Error("Failed to fetch streak");
			return e.json();
		},
		async getChallenges() {
			let e = await fetch("/challenges", { headers: S._headers() });
			if (!e.ok) throw Error("Failed to fetch challenges");
			return e.json();
		},
		async getHeatmap() {
			let e = await fetch("/heatmap", { headers: S._headers() });
...
function re() {
	let [e, t] = (0, w.useState)(!1), [n, r] = (0, w.useState)(null), [i, a] = (0, w.useState)(!1);
	(0, w.useEffect)(() => {
	...
	return e ? /* @__PURE__ */ (0, T.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, T.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, T.jsx)("h2", { children: "Reading Insights" }),
				i && !n ? /* @__PURE__ */ (0, T.jsx)("p", { children: "Loading your insights..." }) : /* @__PURE__ */ (0, T.jsxs)("div", {
					className: "stats-grid",
					children: [
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "Total Books" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.total_books ?? 0 })]
						}),
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "Total Pages" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.total_pages_read ?? 0 })]
						}),
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "This Month" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.pages_this_month ?? 0 })]
						}),
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "Avg / Month" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.avg_pages_per_month ?? 0 })]
						}),
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "🔥 Streak Pages" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.streak_pages_read ?? 0 })]
						}),
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "❄️ Streak This Month" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.streak_pages_this_month ?? 0 })]
						}),
						/* @__PURE__ */ (0, T.jsxs)("div", {
							className: "stat-card",
							children: [/* @__PURE__ */ (0, T.jsx)("h3", { children: "📊 Streak Avg" }), /* @__PURE__ */ (0, T.jsx)("p", { children: n?.avg_streak_pages_per_month ?? 0 })]
						})
					]
				})
			]
...
var w, T, ie, ae = o((() => {
	w = /* @__PURE__ */ l(d()), C(), T = ne(), ie = document.getElementById("react-stats-modal"), ReactDOM.createRoot(ie).render(/* @__PURE__ */ (0, T.jsx)(re, {}));
})), oe = /* @__PURE__ */ s((() => {
	d();
	var e = /* @__PURE__ */ l(_());
	ae();
	var t = ne(), n = document.getElementById("react-stats-modal");
	n && e.createRoot(n).render(/* @__PURE__ */ (0, t.jsx)(re, {}));
}));
//#endregion
export default oe();
